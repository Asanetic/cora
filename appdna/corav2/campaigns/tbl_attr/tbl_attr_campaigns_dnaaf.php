...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'campaigns' => ['primkey','record_id', "post_title",'landing_page', 'target_market','campaign_type','post_status',"ab_testing"],
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "campaigns"=>[ 
                    "Post Details"=>["post_title","post_content"],
                    "Post settings"=>["landing_page","target_market","campaign_type","post_status","ab_testing","date_posted"],
             ]

    ],
    
    //=============================================    image_columns
    "image_columns"=>["post_image"],    
    ...
    "textarea_array"=>['post_content',"column_name2..."],
    
    //============================================    on the profile page for these columns use textarea component
    "content_editable"=>['remark',"column_name2..."],
    
//campaigns //"primkey" , "record_id" , "post_title" , "post_content" , "landing_page" , "target_market" , "post_image" , "campaign_type" , "post_status" , "ab_testing" , "date_posted" ,

    
    //============================================    on the profile page for these columns use drop down with these values component
    "static_drop_down_array"=>['post_status'=>"Active,Inactive,Draft","column_name2..."=>"value1,value2,value3"],
    //sample 
    ...
    "dynamic_drop_down_array"=>["campaign_type"],
    ...
    "title_columns"=>['post_title','column_name2...'],

    //==============================================      | on the profile page, these columns are dates Y-m-d
    "date_columns"=>['date_posteddd',"column_name2..."],

    //=============================================       on the profile page, these columns are datetime Y-m-d H:i:s
    "datetime_columns"=>['date_posted','datke_booked'],
    ...
    "new_label_buttons_arr"=>['campaigns'=>'plus-circle:New campaign : Campaign / {{post_title}}'],
    //sample 
...
//campaigns //"primkey" , "record_id" , "post_title" , "post_content" , "landing_page" , "target_market" , "post_image" , "campaign_type" , "post_status" , "ab_testing" , "date_posted" ,
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>['target_market'=>'audience:record_id:pagename:/api/corav2/audience/audience',
                       "landing_page"=>'landing_pages:record_id:site_title:/api/corav2/landing_pages/landingpages'],
