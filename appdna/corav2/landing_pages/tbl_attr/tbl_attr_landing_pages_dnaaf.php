...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "textarea_array"=>["column_name2..."],
    
    //============================================    on the profile page for these columns use textarea component
    "content_editable"=>['description',"column_name2..."],
    ...
    "new_label_buttons_arr"=>['landing_pages'=>'plus-circle:Add page : Landing page / {{site_title}}'],
    //sample 
