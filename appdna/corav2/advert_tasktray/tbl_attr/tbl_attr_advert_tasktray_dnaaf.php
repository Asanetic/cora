...
$custom_tbl_cols=[
  ...
  "advert_tasktray"=>["audience","posts"],
...
$custom_next_js_query_line_cols=[
  "posts"=>[
    "function" => 'await mosyCountRows("posting_activity", `where task_id =\'${row?.record_id}\'`)',
    "args"=>[],
    "return"=>"data_res"],
  
    "audience"=>[
    "function" => 'await mosyCountRows("audience", `where demographic =\'${row?.platform_target}\'`)',
    "args"=>[],
    "return"=>"data_res"],
...
//advert_tasktray //"primkey" , "record_id" , "task_name" , "active_campaign" , "task_status" , "scehdule_date" , "agent_id" , "weekday" , "platform_target" , "active_market" , "remark" ,

//campaigns //"primkey" , "record_id" , "post_title" , "post_content" , "landing_page" , "target_market" , "post_image" , "campaign_type" , "post_status" , "ab_testing" , "date_posted" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'advert_tasktray' => ['primkey','record_id', "task_name",'active_campaign', 'task_status','audience','posts',"headless"],
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "advert_tasktray"=>[ 
                    "Task details"=>["task_name","active_campaign","platform_target","active_market","agent_name","task_status"],
             ]
    ...
    //============================================    on the profile page for these columns use textarea component
    "content_editable"=>["column_name2..."],
    
    //============================================    on the profile page for these columns use drop down with these values component
    "static_drop_down_array"=>['task_status'=>"Active,Complete,Draft","headless"=>"false,true"],
    //sample 
    ...
    "dynamic_drop_down_array"=>['weekday',"plaktform_target"],
    ...
    "datetime_columns"=>['regdate','task_date'],
    
    //============================================        on the ui , rename these column lables to the new names indicated ...
    "rename_cols_array"=>['scehdule_date'=>'Client name'],

    //rename the following tables with the indicated alises on the ui 
    "rename_tables_array"=>['advert_tasktray'=>'Post activity'],
    ...
    "new_label_buttons_arr"=>['advert_tasktray'=>'plus-circle:Run post:Post activity profile / {{task_name}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "custom_profile_col_data"=>["posts"=>"?","audience"=>"?"],
    
    "custom_profile_default_data"=>[],
    
    //=============================================        on the ui , these columns connect values from other tables
    "connection_cols"=>[
      'active_campaign'=>'campaigns:record_id:post_title:/api/corav2/campaigns/campaigns',
      'platform_target'=>'audience:demographic:demographic:/api/corav2/audience/audience',
      'active_market'=>'audience:record_id:pagename:/api/corav2/audience/audience',
      "agent_name"=>'advert_agents:record_id:agent_name:/api/corav2/advert_agents/advertagents'
