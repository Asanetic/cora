...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'posting_activity' => ['primkey','record_id', "screen_shot",'posted_status',"market_name","campaign_id"],

    ],
    
//posting_activity //"primkey" , "record_id" , "url" , "market_name" , "campaign_id" , "task_id" , "dateposted" , "posted_status" , "landing_page" , "screen_shot" ,    
    ...
    "textarea_array"=>['remagrk',"column_name2..."],
    ...
    "dynamic_drop_down_array"=>['room_type',"phone_number"],
    ...
    "new_label_buttons_arr"=>['clients'=>'plus-circle:New guest'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>[
          'campaign_id'=>'campaigns:record_id:post_title:/api/corav2/campaigns/campaigns',      'market_name'=>'audience:record_id:pagename:/api/corav2/audience/audience',
    ],
